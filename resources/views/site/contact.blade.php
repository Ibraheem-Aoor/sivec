         ...
         <div class="container">
             <div class="row mrb-80">
                 <div class="col-md-12 col-lg-12 col-xl-4">
                     ...
                     <ul class="social-list list-md list-primary-color list-flat mrb-lg-60 clearfix">
                         <li><a target="blank" href="{{ @$site_settings['facebook'] }}"><i
                                     class="fab fa-facebook-f"></i></a></li>
                         <li><a target="blank" href="{{ @$site_settings['twitter'] }}"><i class="fab fa-twitter"></i></a>
                         </li>
                         <li><a target="blank" href="{{ @$site_settings['instagram'] }}"><i
                                     class="fab fa-instagram"></i></a></li>
                         <li><a target="blank" href="{{ @$site_settings['linked_in'] }}"><i class="fab fa-linkedin"></i></a>
                         </li>
                         <li><a target="blank" href="{{ @$site_settings['snapchat'] }}"><i class="fab fa-snapchat"></i></a>
                         </li>
             ...
             <div class="row text-center">
                             ...
                             <div class="row">
                                 ...
                                 <div class="col-lg-8">
                                     <div class="form-group">
                                         <button type="submit" class="animate-btn-style3 btn-md mrb-lg-60 mb-5">Submit
                                             Now</button>
                 ...
                 <div class="col-lg-6 col-xl-6">
                     <div class="contact-block d-flex mrb-30" id="mt-5">
                         <div class="contact-icon">
                             <i class="fab fa-whatsapp"></i>
                         </div>
                         <div class="contact-details mrl-30">
                             <h3><a href="https://wa.me/971{{ @$site_settings['whatsaap_number'] }}"
                                     target="_blank">{{ @$site_settings['whatsaap_number'] }}</a> </h3>
                         </div>
                     </div>
