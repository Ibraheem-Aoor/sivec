...
<html lang="en" class="light-style layout-navbar-fixed layout-menu-fixed layout-compact" dir="ltr"
    data-theme="theme-default" data-assets-path="{{ asset('assets/dashboard') }}/" data-template="vertical-menu-template"
    data-style="light">
...
<head>
    ...
    <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
    <link
        href="https://fonts.googleapis.com/css2?family=Alexandria:wght@100..900&family=Cairo:slnt,wght@-1,200..1000&display=swap"
        rel="stylesheet">

    @include('layouts.admin.style2')
...
<body>
    ...
    <!-- Core JS -->
    @include('layouts.admin.scripts2')
</body>
