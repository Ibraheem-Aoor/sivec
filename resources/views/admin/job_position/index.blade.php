...
@section('content')
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-2">
                            <button class="btn btn-outline-primary" data-bs-toggle="modal"
                                data-bs-target="#job-position-create-update-modal"
                                data-action="{{ route('admin.job-position.store') }}" data-method="POST"
                                data-is-create="1">
                                {{ __('custom.new') }}
                            </button>
                        </div>
    ...
    @include('admin.job_position.job-position-create-update-modal')
@endsection
...
@push('js')
    ...
    <script src="{{ asset('admin_assets/dist/js/custom/job_position.js') }}"></script>
@endpush
