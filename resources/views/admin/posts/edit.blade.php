                        ...
                        <section id="add-post" class="add-post-section mb-5">
                            ...
                            <div class="post-form p-3 border rounded">
                                ...
                                <div class="form-group my-4">
                                    ...
                                    <textarea name="description_ar" id="postContentAr" class="form-control mb-2" rows="3">{{ $post->translate('ar')->description }}</textarea>
                                </div>
                                <div class="form-group my-4">
                                    <label for="postContentEn">{{ __('blog.description_en') }}</label>
                                    <textarea name="description_en" id="postContentEn" class="form-control mb-2" rows="3">{{ $post->translate('en')->description }}</textarea>
                                </div>
                                <div class="form-group my-4">
                                ...
                                <div class="form-group my-4">
                                    ...
                                    <div class="row">
                                        @foreach ($tags as $tag)
                                            <div class="col-md-2">
                                                <input @checked(in_array($tag->id, $post->tags->pluck('id')->toArray())) value="{{ $tag->id }}"
                                ...
                                <!-- Post Button -->
                                <button type="submit" class="btn btn-primary post-btn">{{ __('blog.edit_post') }}</button>
                            </div>
                        </section>
                    </form>
                </section>
