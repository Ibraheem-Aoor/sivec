                        ...
                        <section id="add-post" class="add-post-section mb-5">
                            ...
                            <div class="post-form p-3 border rounded">
                                ...
                                <div class="form-group">
                                    <label class='mt-3' for="postTitleAr">{{ __('blog.title_ar') }}</label>
                                ...
                                <div class="form-group my-3">
                                    <label class='mt-3' for="postTitleEn">{{ __('blog.title_en') }}</label>
                                ...
                                <div class="form-group my-3">
                                    <label class='mt-3' for="postContentAr">{{ __('blog.description_ar') }}</label>
                                ...
                                <div class="form-group my-3">
                                    <label class='mt-3' for="postContentEn">{{ __('blog.description_en') }}</label>
                                ...
                                <div class="form-group my-3">
                                    <!-- Image Upload -->
                                    <label class='mt-3' for="postImage">{{ __('blog.image') }}</label>
                                ...
                                <div class="form-group my-3">
                                    <label class='mt-3' for="postCategory">{{ __('blog.category') }}</label>
                                ...
                                <div class="form-group my-3">
                                    ...
                                    <label class='mt-3'>{{ __('blog.tag') }}</label>
                                    <div class="row">
                                        @foreach ($tags as $tag)
                                            ...
                                            <div class="col-md-2">
                                                ...
                                                <label class='mt-3' for="id={{ $tag->title }}">{{ $tag->title }}</label>
                                            </div>
                                        @endforeach
                                    </div>
                                    @error('tags')
